...
jsonSource_Major_Towns_4.addFeatures(features_Major_Towns_4);cluster_Major_Towns_4 = new ol.source.Cluster({
  distance: 10,
  source: jsonSource_Major_Towns_4
});
var lyr_Major_Towns_4 = new ol.layer.Vector({
                declutter: true,
                source:cluster_Major_Towns_4, 
                style: style_Major_Towns_4,
                interactive: true,
                title: '<img src="styles/legend/Major_Towns_4.png" /> Major_Towns'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_District_1.setVisible(true);lyr_Streams_2.setVisible(true);lyr_Road_3.setVisible(true);lyr_Major_Towns_4.setVisible(true);
var layersList = [lyr_GoogleMaps_0,lyr_District_1,lyr_Streams_2,lyr_Road_3,lyr_Major_Towns_4];
...
lyr_Major_Towns_4.set('fieldLabels', {'ID': 'inline label', 'NAME': 'inline label', });
